...
<div class="publication-page-head">
  <h1>Publications</h1>
...
<article class="publication-item">
  <h3>Constrained Auto-Regressive Decoding Constrains Generative Retrieval.</h3>
  <p class="pub-meta"><span class="pub-venue">SIGIR 2025</span><span class="pub-rank">CCF-A</span></p>
  <p class="pub-authors">Shiguang Wu, Zhaochun Ren, Xin Xin, Jiyuan Yang, <strong>Mengqi Zhang</strong>, Zhumin Chen, Maarten de Rijke, Pengjie Ren</p>
</article>

<article class="publication-item">
  <h3>Contrastive Domain Adaptation with Test-Time Training for Out-of-Context News Detection.</h3>
  <p class="pub-meta"><span class="pub-venue">Pattern Recognition 2025</span><span class="pub-rank">CCF-B</span></p>
...
<article class="publication-item">
  <h3>Mini-Ensemble Low-Rank Adapters for Parameter-Efficient Fine-Tuning.</h3>
  <p class="pub-meta"><span class="pub-venue">ACL 2024</span><span class="pub-rank">CCF-A</span></p>
  <p class="pub-authors">Pengjie Ren, Chengshun Shi, Shiguang Wu, <strong>Mengqi Zhang</strong>, Zhaochun Ren, Maarten de Rijke, Zhumin Chen, Jiahuan Pei.</p>
</article>

<article class="publication-item">
  <h3>Self-Supervised Position Debiasing for Large Language Models.</h3>
  <p class="pub-meta"><span class="pub-venue">Findings of ACL 2024</span><span class="pub-rank">CCF-A</span></p>
  <p class="pub-authors">Zhongkun Liu, Zheng Chen, <strong>Mengqi Zhang</strong>, Zhaochun Ren, Zhumin Chen, Pengjie Ren.</p>
</article>
...
<article class="publication-item">
  <h3>MetaTKG++: Learning Evolving Factor Enhanced Meta-Knowledge for Temporal Knowledge Graph Reasoning.</h3>
  <p class="pub-meta"><span class="pub-venue">Pattern Recognition 2024</span><span class="pub-rank">CCF-B</span></p>
...
<article class="publication-item">
  <h3>Stage-Aware Hierarchical Attentive Relational Network for Diagnosis Prediction.</h3>
  <p class="pub-meta"><span class="pub-venue">IEEE TKDE 2023</span><span class="pub-rank">CCF-A</span></p>
...
<article class="publication-item">
  ...
  <p class="pub-authors">Jianghao Zhang, Yanqiao Zhu, Qiang Liu, <strong>Mengqi Zhang</strong>, Shu Wu, and Liang Wang.</p>
</article>

<article class="publication-item">
  <h3>MetaTKG: Learning Evolutionary Meta-Knowledge for Temporal Knowledge Graph Reasoning.</h3>
  <p class="pub-meta"><span class="pub-venue">EMNLP 2022</span><span class="pub-rank">CCF-B</span></p>
  <p class="pub-authors">Yuwei Xia, <strong>Mengqi Zhang</strong>, Qiang Liu, Shu Wu, and Xiaoyu Zhang.</p>
</article>
...
<article class="publication-item">
  ...
  <p class="pub-meta"><span class="pub-venue">Physica A 2019</span></p>
  <p class="pub-authors"><strong>Mengqi Zhang</strong>, Xin Jiang, Zehua Fang, Yue Zeng, and Ke Xu.</p>
</article>
